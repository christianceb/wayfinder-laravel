...
@section('content')
  <div class="container">
    ...
    <a class="btn btn-success" href="{{ route('uploads.index') }}" role="button">Back to Uploads</a>
    ...
    <div class="row">
      ...
      <div class="col-4">
        ...
        <a class="btn btn-primary" href="{{ route('uploads.edit', $upload) }}" role="button">Edit</a>
